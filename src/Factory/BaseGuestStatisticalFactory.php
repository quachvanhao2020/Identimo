...
use Identimo\Statistical\GuestStatistical;
use YPHP\Filter\StatisticalFilter;

abstract class BaseGuestStatisticalFactory implements ContainerFactoryInterface{
